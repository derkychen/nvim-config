...
--- Gets a relative path in a custom format.
---
...
--- Gets the width of a border style.
---
...
--- @return integer height Height added by the border style. Must be 0, 1, or 2.
--- @return integer width Width added by the border style. Must be 0, 1, or 2.
